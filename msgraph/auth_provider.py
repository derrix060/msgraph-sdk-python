...
class AuthProvider(AuthProviderBase):
    ...
    MSA_AUTH_SERVER_URL = 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize'
    MSA_AUTH_TOKEN_URL = 'https://login.microsoftonline.com/common/oauth2/v2.0/token'
    ...
    def __init__(self, 
                 ...
                 access_token=None,
                 session_type=None,
                 auth_server_url=MSA_AUTH_SERVER_URL,
                 auth_token_url=MSA_AUTH_TOKEN_URL,
                 loop=None,
                 redirect_url=None):
    ...
    def get_auth_url(self, response_type=None):
    ...
    def authenticate(self, code, client_secret, resource=None):
